...
from RecaptchaResolver.captcha_resolver import CaptchaResolver
from RecaptchaResolver.settings import CAPTCHA_ENTIRE_IMAGE_FILE_PATH, CAPTCHA_SINGLE_IMAGE_FILE_PATH
from RecaptchaResolver.utils import get_question_id_by_target_name, resize_base64_image, to_base64_image
